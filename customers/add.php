...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO clients (name, phone, email, address, created_at) VALUES (:name, :phone, :email, :address, NOW())");
        $stmt->execute([
            ':name' => $name,
            ':phone' => $phone,
            ':email' => $email,
        ...
        flash('success', __('customer_added_successfully'));
        header('Location: list.php');
        exit();
    } catch (PDOException $e) {
        flash('error', __('error_adding_customer') . $e->getMessage());
    }
}

$pageTitle = __('add_new_customer');
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900"><?php echo __('create_new_customer'); ?></h1>
                    <p class="mt-1 text-gray-600"><?php echo __('fill_details_below'); ?></p>
                </div>
                <a href="list.php" 
        ...
        <div class="bg-white shadow-xl rounded-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-cyan-600 px-8 py-6">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-white"><?php echo __('customer_information'); ?></h2>
                        <p class="text-blue-100 mt-1"><?php echo __('fill_details_below'); ?></p>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="name" name="name" required
                                   ...
                                   placeholder="<?php echo __('enter_customer_name'); ?>">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email"
                                   class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200"
                                   placeholder="<?php echo __('enter_email_address_optional'); ?>">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <textarea id="address" name="address" rows="4"
                                      class="pl-10 w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200"
                                      placeholder="<?php echo __('enter_customer_address_optional'); ?>"></textarea>
                        </div>
                    </div>
        ...
        <div class="mt-8 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-start space-x-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900 mb-2"><?php echo __('important_information'); ?></h3>
                    <ul class="text-sm text-gray-600 space-y-1">
                        <li>• <strong><?php echo __('required_fields_marked'); ?></strong></li>
                        <li>• <?php echo __('phone_required_contact'); ?></li>
                        <li>• <?php echo __('email_optional_recommended'); ?></li>
                        <li>• <?php echo __('address_helps_delivery'); ?></li>
                        <li>• <?php echo __('customer_info_sales_invoicing'); ?></li>
                    </ul>
                </div>
            </div>
        </div>
