        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Analytics Charts</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div class="stat-card">
                    ...
                    <div class="stat-label">Months of Sales Data</div>
                </div>
                <div class="stat-card">
                    <div class="stat-value"><?php echo getSetting('currency_symbol', 'DH'); ?><?php echo number_format(array_sum(array_column($monthly_sales, 'revenue')), 0); ?></div>
                    <div class="stat-label">Total Revenue (12 months)</div>
                </div>
                <div class="stat-card">
                    <div class="stat-value"><?php echo count($top_customers); ?></div>
                    <div class="stat-label">Active Customers</div>
                </div>
                <div class="stat-card">
                    <div class="stat-value"><?php echo count($supplier_performance); ?></div>
